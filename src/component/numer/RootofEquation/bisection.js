...
// !!!!!!!!!
  ...
  onSubmit () {
    ...
    console.log(this.state);
    //// เรียก mathod อื่นโดยการใช้ this ได้เลยย
      ...
      const { size } = this.state;
        return (
          <div id="content" style={{ padding: 24, background: '#fff', minHeight: 360 }}>
            ...
            <Title style = {{textAlign: 'center'}}>Bisection Method</Title>
            <br></br>
            ...
            >
              <h4>Equation  : &nbsp;&nbsp;               
                <Input size="large" placeholder="Input your Function" name = "fx"style={{ width: 250 }}
